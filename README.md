...
| **Secure Login System** | Safe authentication + input validation | Python, HTML/CSS |
| **Flask REST API** | Secure API + Nginx deployment | Flask, Nginx |
| **TryHackMe Labs** | Blue & Red team practical cybersecurity | THM |
...
- Completing more TryHackMe pathways  
